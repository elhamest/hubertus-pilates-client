      ...
      <nav className="container relative flex flex-wrap items-center justify-between mx-auto">
        ...
        >
          ...
          <button
            ...
            className="px-2 py-1 text-accentColorBlue rounded-md lg:hidden hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:text-accentColorGary dark:focus:bg-darkGray-700"
            onClick={toggleMenu}
          >
            <svg
