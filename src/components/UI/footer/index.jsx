...
export function Footer() {
  ...
  return (
    <div className={styles.FooterWrapper} id="contact-us">
      <Container>
        <div className={styles.footerContainer}>
          <div className={styles.slugWrapper}>
            ...
            <div className={styles.description}>{faConstants.footerSlug}</div>
          </div>
          ...
          <div className={styles.contactSection}>
            <div>
              <div className={styles.sectionTitle}>{faConstants.followUs}</div>
            ...
            <div className={styles.telWrapper}>
              <div className={styles.sectionTitle}>{faConstants.contactUs}</div>
